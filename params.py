...
class Params:
	...
	def use_default(self, dataset, model):
		...
		elif dataset == "dmda" and model == "SimplE_ignr":
			self.set_values(lr=0.1, alpha=0.03, bsize=10000, max_itr=2000, emb_size=200, neg_ratio=1, save_after=100, save_each=100)
		elif dataset == "dmda" and model == "SimplE_avg":
			self.set_values(lr=0.05, alpha=0.1, bsize=4832, max_itr=1000, emb_size=200, neg_ratio=10, save_after=100, save_each=100)
		elif dataset == "dmda" and model == "ComplEx":
			self.set_values(lr=0.05, alpha=0.01, bsize=10000, max_itr=4000, emb_size=200, neg_ratio=10, save_after=100, save_each=100)
		elif dataset == "dmda" and model == "TransE":
			self.set_values(lr=0.01, alpha=0.25, gamma=1.0, p_norm=1, bsize=2000, max_itr=2000, emb_size=100, save_after=100, save_each=100)

		else:
			self.set_values(lr=0.1, alpha=0.001, gamma=2.0, p_norm=1, bsize=1415, max_itr=1000, emb_size=100, neg_ratio=1, save_after=50, save_each=50)
